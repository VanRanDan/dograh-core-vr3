...
description: "How VR3 AI handles telephony webhooks and audio streaming"
---

## Overview

VR3 AI uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
