...
**VR3 AI is an open-source alternative to platforms like Vapi and Retell** - VR3 AI helps you build voice AI agents with an easy drag-and-drop workflow builder. Unlike proprietary solutions like Vapi, VR3 AI gives you:
...
## Overview
Watch the following video to learn about VR3 AI’s capabilities.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/sxiSp4JXqws"
  title="VR3 AI Overview"
