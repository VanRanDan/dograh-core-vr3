---
title: "Prerequisites"
description: "System requirements and setup needed to run VR3 AI locally"
---
...
To run VR3 AI locally, make sure you have the following installed:
...
VR3 AI images are available from two registries:
