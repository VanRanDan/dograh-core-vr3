...
The option to create the Keys are in https://vr3ai.tapcloud.org/api-keys if you are using hosted version, or http://localhost:3010/api-keys if you are using the self hosted version.
